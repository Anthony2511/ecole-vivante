    ...
    <div class="contact-page__container">
        ...
        <div class="contact-page__bloc">
            <form action="" class="contact-page__form">
                <div class="contact-page__form__champ">
                ...
                <div class="contact-page__form__champ">
                    ...
                    <textarea name="message" id="message" cols="30" rows="10" class="contact-page__form-textarea"></textarea>
                </div>
                <input type="submit" value="Envoyez votre message" class="button">
            </form>
        </div>
    </div>
</section>
